...
#.\DeployLA -Environment $Environment -LogicAppFolder "$Environment-api-ticket-la" -BranchName $BranchName
...
#.\DeployAppSettings -Environment $Environment -LogicAppFolder "$Environment-api-ticket-la" -BranchName $BranchName
