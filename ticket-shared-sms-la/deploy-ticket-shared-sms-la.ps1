...
# Author:      ctp
# Date:        auto generated
# Description: Migration deployment for ticket shared logic app
#======================================================================
...
.\DeployLA -Environment $Environment -LogicAppFolder "ticket-shared-sms-la" -BranchName $BranchName
.\DeployWF -Environment $Environment -LogicAppFolder "ticket-shared-sms-la" -BranchName $BranchName

# Deploy AppSettings artifacts
.\DeployAppSettings -Environment $Environment -LogicAppFolder "ticket-shared-sms-la" -BranchName $BranchName
